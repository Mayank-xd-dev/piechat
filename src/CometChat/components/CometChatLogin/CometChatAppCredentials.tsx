          ...
          <div className="cometchat-credentials__form-group">
            ...
            <div className="cometchat-credentials__region-wrapper">
              <div
                ...
                className={`cometchat-credentials__region ${region === 'us' ? 'cometchat-credentials__region-selected' : ' '
                  }`}
              >
                <img src={usIcon} alt="" />
              ...
              <div
                ...
                className={`cometchat-credentials__region ${region === 'eu' ? 'cometchat-credentials__region-selected' : ' '
                  }`}
              >
                <img src={euIcon} alt="" />
              ...
              <div
                ...
                className={`cometchat-credentials__region ${region === 'in' ? 'cometchat-credentials__region-selected' : ' '
                  }`}
              >
                <img src={inIcon} alt="" />
